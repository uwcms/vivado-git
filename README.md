...
You may find it at https://gitlab.cern.ch/WisconsinCMS/Misc/vivado-git
...
```sh
git remote set-url origin ssh://git@gitlab.cern.ch:7999/WisconsinCMS/Misc/vivado-git.git
```
...
```sh
git remote set-url origin https://gitlab.cern.ch/WisconsinCMS/Misc/vivado-git.git
```
